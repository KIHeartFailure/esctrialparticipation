...
orforest <- orforest %>%
  mutate(
    modnameforest = case_when(
      ...
      Variable == "num_dmhome_catHome with family(partner)" ~ "Home with family vs Home alone",
      Variable == "num_dmhome_catOther" ~ "Other vs Home alone",
...
axis(1,
  cex.axis = cextext, at = log(c(minmy, 1, 2)),
  labels = c(minmy, 1, 2)
)
